...
type UserUSDTDeposits struct {
	...
	CountryID   int64     `json:"country_id" form:"country_id" gorm:"column:country_id;"`       // 国家ID
	CountryName string    `json:"country_name" form:"country_name" gorm:"column:country_name;"` // 国家名称
